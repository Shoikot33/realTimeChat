...
export default class ApiErrorModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
        ...
        return (
            ...
            >
                <View style={{ justifyContent: "center", alignContent: "center", backgroundColor: Settings.colorWhite }}>
                    ...
                    <H3Bold textTitle={"এই সমস্যাটি সাময়িক"} textStyle={{ color: Settings.colorBlack, textAlign: "center", marginBottom: 10 }} />
                    <H5 textTitle={"টেকনিক্যাল সমস্যার কারণে এটা হচ্ছে। কিছুক্ষনের মধ্যেই ঠিক হয়ে যাবে"} textStyle={{ color: Settings.colorBlack, alignSelf: "center", marginBottom: 30,width: "70%",textAlign: "center" }} />
